...
Note, the 106 homogeneous map spec occurrences were sourced from only 3 projects, one project contributing the maximum 93 occurrences.
Heterogeneous map specs occurrences were from 7 projects, with maximum 30 occurrences in one project.
}
\label{fspectable}
\end{figure*}
